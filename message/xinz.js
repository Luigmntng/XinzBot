...
//------------------< VVIBU >-------------------
			case prefix+'waifu':{
                ...
                reply(mess.wait)
						...
						.then(({data}) => {
						sendFileFromUrl(from, data.link, 'Istri gwehj 😡', msg)
						})
						limitAdd(sender, limit)
						}
                      break
			...
			case prefix+'megumin':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
						sendFileFromUrl(from, `https://api-ramlan.herokuapp.com/api/megumin?apikey=${apikey}`, 'istri gwehj😡', msg)
						limitAdd(sender, limit)
						}
                      break
			case prefix+'sagiri':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
						sendFileFromUrl(from, `https://api-ramlan.herokuapp.com/api/sagiri?apikey=${apikey}`, 'Istri gwejh😡', msg)
						limitAdd(sender, limit)
						}
                      break
			case prefix+'shinobu':{
                ...
                reply(mess.wait)
						...
						.then(({data}) => {
						sendFileFromUrl(from, data.url, 'istri gwejh😡', msg)
						})
						limitAdd(sender, limit)
						}
                      break
            case prefix+'nezuko':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
						axios.get('https://myselfff.herokuapp.com/docs/anime/nezuko')
						.then(({data}) => {
						sendFileFromUrl(from, data.url, 'istri gwejh😡', msg)
						})
						limitAdd(sender, limit)
            ...
            case prefix+'loli':{
                ...
                axios.get(`https://api-ramlan.herokuapp.com/api/loli?apikey=${apikey}`)
						.then(({data}) => {
						sendFileFromUrl(from, data.link, 'lu pedo yh vangh?', msg)
						})
						limitAdd(sender, limit)
						}
                      break
            case prefix+'shota':{
                ...
                axios.get(`https://api-ramlan.herokuapp.com/api/shota?apikey=${apikey}`)
						.then(({data}) => {
						sendFileFromUrl(from, data.link, 'Adek gwehj', msg)
						})
						limitAdd(sender, limit)
						}
                      break
            case prefix+'nezuko2'
           anu = await fetchJson('https://myselfff.herokuapp.com/docs/anime/nezuko')
           anu = anu.result
           buff = await getBuffer(anu.list)
           sendMessage(from, buff, image, {quoted : mek}
           break
            case prefix+'husbu':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
                axios.get(`https://api-ramlan.herokuapp.com/api/husbu?apikey=${apikey}`)
						.then(({data}) => {
						sendFileFromUrl(from, data.link, 'Suami Luh kartun?', msg)
						})
						limitAdd(sender, limit)
						}
                      break
//------------------< nsfw >-------------------
            ...
            case prefix+'trap':{
                ...
                if (!isGroup)return reply(mess.OnlyGrup)
                reply(mess.wait)
						sendFileFromUrl(from, `https://api-ramlan.herokuapp.com/api/nsfw/${command.slice(1)}?apikey=${apikey}`, 'Antum birahi sama kartun?😡', msg)
						limitAdd(sender, limit)
						}						
                      break
            case prefix+'neko':
            ...
            case prefix+'kuni':{
                ...
                .then(({data}) => {
						sendFileFromUrl(from, data.url, 'Antum birahi sama kartun?😡', msg)
						})
						limitAdd(sender, limit)
						}						
                      break
